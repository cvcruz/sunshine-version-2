...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertFalse("Error inserting location", locationRowId == -1L);
        ...
        assertTrue("Error: No records returned from weathery query", weatherCursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error",weatherCursor,weatherValues);

        //Validate that only one record is returned
